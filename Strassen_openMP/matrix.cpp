...
Matrix Matrix::operator +(const Matrix& m){
    ...
    for (int i=0;i<m.row;i++){
        for (int j=0;j<m.col;j++){
            temp.matbeg[i][j]=matbeg[i][j]+m.matbeg[i][j];
...
//                cout<<"M7 is \n"<<M7<<endl;
        ...
        Matrix C11=M1+M2-M4+M6;
        
        Matrix C12=M4+M5;
        
        Matrix C21=M6+M7;
    
        Matrix C22=M2-M3+M5-M7;
//        cout<<"C11 is\n"<<C11<<endl;
//        cout<<"C12 is\n"<<C12<<endl;
//        cout<<"C21 is\n"<<C21<<endl;
//        cout<<"C22 is\n"<<C22<<endl;
...
//void Strassen1(Matrix& A,Matrix& B,Matrix&C, int N){
//    N=N/2;
//    
//    
//    if (N<=1){
...
//    for (int i=0;i<N;i++){
//        for (int j=0;j<N;j++){
//            C.matbeg[i][j]=C11.matbeg[i][j];
//            C.matbeg[i][j+N]=C12.matbeg[i][j];
//            C.matbeg[i+N][j]=C21.matbeg[i][j];
//            C.matbeg[i+N][j+N]=C22.matbeg[i][j];
//            
//        }
//    }
//    //        cout<<"temp is"<<temp<<endl;
